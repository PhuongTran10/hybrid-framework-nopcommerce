...
public class Level_08_Switch_Role extends BaseTest{
	...
	public void beforeClass(String browserName, String environment) {
		driver = getBrowserDriverLocal(browserName,environment);
	...
	public void Role_01_User_To_Admin() {
		...
		useHomePage.openPageUrl(driver, GlobalConstants.getGlobalConstants().getAdmin_dev_url());
	...
	public void Role_02_Admin_To_User() {
		adminLoginPage.openPageUrl(driver, GlobalConstants.getGlobalConstants().getUser_dev_url());
		useHomePage = PageGeneratorManager.getUserHomePage(driver);
		userLoginPage = useHomePage.clickToLoginLink();
		useHomePage = userLoginPage.loginAsUser(userEmail,userPassword);
		Assert.assertTrue(useHomePage.isMyAccountLinkDisplayed());
